...
<header class="site-header section-padding-img site-header-image">
    ...
    <img src="{{ asset('depan/images/header/positive-european-woman-has-break-after-work.jpg') }}" class="header-image img-fluid" alt="">
</header>
            ...
            <div class="col-lg-6 col-12 mt-5 ms-auto">
                <div class="row">
                    ...
                    <div class="col-6 border-top border-end contact-info">
                        ...
                        <p class="text-muted">Jl. Bendungan Hilir No.17, RT.4/RW.3, Bend. Hilir, Kecamatan Tanah Abang, Kota Jakarta Pusat</p>
                    </div>
